...
impl HashValue {
    ...
    pub fn perfect_hash(feature: &Vec<f32>, nbin_dist: usize, nbin_angle: usize) -> u32 {
        ...
        let cos_phi_12 = discretize_value(cos_phi_12, MIN_SIN_COS, MAX_SIN_COS, nbin_angle);
        let cos_phi_34 = feature[1].cos();
        let cos_phi_34 = discretize_value(cos_phi_34, MIN_SIN_COS, MAX_SIN_COS, nbin_angle);
        let cos_phi_15 = feature[2].cos();
        let cos_phi_15 = discretize_value(cos_phi_15, MIN_SIN_COS, MAX_SIN_COS, nbin_angle);
        let cos_phi_35 = feature[3].cos();
        let cos_phi_35 = discretize_value(cos_phi_35, MIN_SIN_COS, MAX_SIN_COS, nbin_angle);
        let cos_phi_14 = feature[4].cos();
        let cos_phi_14 = discretize_value(cos_phi_14, MIN_SIN_COS, MAX_SIN_COS, nbin_angle);
        let cos_phi_23 = feature[5].cos();
        let cos_phi_23 = discretize_value(cos_phi_23, MIN_SIN_COS, MAX_SIN_COS, nbin_angle);
        let cos_phi_13 = feature[6].cos();
        let cos_phi_13 = discretize_value(cos_phi_13, MIN_SIN_COS, MAX_SIN_COS, nbin_angle);
        let ca_dist = discretize_value(feature[7], MIN_DIST, MAX_DIST, nbin_dist);
    ...
    pub fn reverse_hash(&self, nbin_dist: usize, nbin_angle: usize) -> [f32; 9] {
        ...
        [
            cos_phi_12, cos_phi_34, cos_phi_15, cos_phi_35, cos_phi_14, cos_phi_23, cos_phi_13,
            ca_dist, seq_dist,
        ]
    }
...
mod tests {
    ...
    fn test_geometrichash_works() {
        ...
        let raw_feature = vec![
            raw_feature.0.to_radians(),
            raw_feature.1.to_radians(),
            raw_feature.2.to_radians(),
            raw_feature.3.to_radians(),
        ...
        let hash: GeometricHash = GeometricHash::TertiaryInteraction(HashValue(
